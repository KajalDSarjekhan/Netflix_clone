...
const Cast = () => {
    ...
    useEffect(()=>{
      ...
      fetch(`https://api.themoviedb.org/3/search/person?api_key=ab1da08307f82007e9975d4dccf67670&include_adult=false&language=en-US&page=1&query=${castName}`)
      .then(res=>res.json())
      .then(d=>setCastDtl(d.Cast)) 
